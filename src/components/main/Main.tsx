            ...
            <div className={`${sContainer.container} ${s.container}`}>
                <div className={s.introduce}>
                    ...
                    <p className={s.info}><span className={s.mainInfo}><b>Имею двухлетний опыт разработки.</b></span> <br/> Разрабатываю
                        ...
                        различных устройств и разрешений экранов. <br/><b>Декомпозирую</b> масштабные задачи на более мелкие.<br/><b>Оптимизирую компоненты для максимальной производительности</b> веб-страниц, загрузку
